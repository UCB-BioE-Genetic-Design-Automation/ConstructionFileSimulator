...
public class Endonuclease{
    ...
    public Endonuclease(String sequence, String ext5, String ext3) {
    ...
    public static void main(String[] args) {
        
        {
            ...
            String ext5 = "GATC";
            String ext3 = "AATT";
            Endonuclease poly1 = new Endonuclease("caaacccg", ext5, ext3);
...

        {
            ...
            String ext5 = "-TGCA";
            String ext3 = "-CC";
            Endonuclease poly2 = new Endonuclease("gaaacccGAGGAGaaaaaaaa", ext5, ext3);

...
public class Polynucleotide {
    ...
    public Polynucleotide(String sequence, String ext5, String ext3, boolean isDoubleStranded, boolean isRNA, boolean isCircular, Modifications mod_ext3, Modifications mod_ext5) {
    ...
    /**
     * Convenience constructor defaults to blunt PCR product, double stranded DNA, which can
     * then be edited - 
     *
     * @param dnaseq
     */
    ...
    public Modifications mod_ext3() { //!!!
        return mod_ext3;
    }
    
    public Modifications mod_ext5() {// !!!
        return mod_ext5;
    }
    ...
    public String toString() {
        ...
        if(this.mod_ext5 == Modifications.phos5){
            modS = "p";

        }else if(!(this.mod_ext5 == Modifications.hydroxyl | this.mod_ext5 == Modifications.circular)){

            Modifications mod = this.mod_ext3;
            modS = mod.toString();
        ...
        if (this.ext3.startsWith("-")) {
            ...
            out += SequenceUtils.complement(this.ext3)+modS;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(this.mod_ext3 == Modifications.circular | this.mod_ext5 == Modifications.circular)) { //!!!!
